...
public class TalentValidator(IVersion lastVersion, ITalentCalculator talentCalculator) : ITalentValidator
{
    public void Validate(ITalentBuildSource character)
    {
        ...
        talentCalculator.GetFreeTalents(character).Pipe(freeTalents =>
        {
            if (freeTalents < 0)
            {
