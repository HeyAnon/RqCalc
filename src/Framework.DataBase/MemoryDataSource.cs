...
public class MemoryDataSource<TPersistentDomainObjectBase> : IDataSource<TPersistentDomainObjectBase>
    where TPersistentDomainObjectBase : class
{
    ...
    public MemoryDataSource(ITypeResolver<Type> implementTypeResolver, IEnumerable<TPersistentDomainObjectBase> source)
    {
