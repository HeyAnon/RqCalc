...
namespace Framework.Reactive
{
    public static class ObservableExtensions
    {
        ...
        public static IObservable<PropertyChangedEventArgs> ToObservableWithout<T>(this T source, Expression<Func<T, object>> noObservablePropertyExpression, params Expression<Func<T, object>>[] noObservablePropertyExpressions)
            where T : INotifyPropertyChanged
        {
            return source.ToObservableWithout(noObservablePropertyExpressions.Concat(new[] { noObservablePropertyExpression }));
        }
        ...
        public static IObservable<PropertyChangedEventArgs> ToObservable<T>(this T source, Expression<Func<T, object>> observablePropertyExpression)
            where T : INotifyPropertyChanged
        {
            return source.ToObservable(observablePropertyExpression.ToPath());
        }
        ...
        public static IObservable<NotifyCollectionChangedEventArgs> ToCollectionObservable(this INotifyCollectionChanged source)
        {
        ...
        public static IObservable<T> AsObservable<T>(this T obj)
        {
            return Observable.Empty<T>().StartWith(obj);
        }
