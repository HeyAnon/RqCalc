...
namespace Framework.Reactive.ObservableRecurse
{
    public static class ObservableRecurseHelper
    {
        ...
        {
            return new SubscribeState<TSource> (source, subRules, false);
        }
        ...
        public static IDisposable SubscribeExplicitLock<TSource> (this TSource source, params Func<ObservableRule<TSource>, ILinkNode>[] subRules)
           where TSource : class, INotifyPropertyChanged
        {
            return new SubscribeState<TSource> (source, subRules, true);
        }
        

        public static IDisposable SubscribeTotal (this INotifyPropertyChanged source, PropertyChangedEventHandler handler)
        {
            return new SubscribeTotalState (source, handler);
        }
    }
}