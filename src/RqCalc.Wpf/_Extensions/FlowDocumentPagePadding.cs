...
{
    public static Thickness GetPagePadding(DependencyObject obj) => (Thickness)obj.GetValue(PagePaddingProperty);

    public static void SetPagePadding(DependencyObject obj, Thickness value) => obj.SetValue(PagePaddingProperty, value);
    ...
    public static void PaddingChanged(object s, EventArgs e) => ((FlowDocument)s).PagePadding = GetPagePadding((DependencyObject)s);
}