...
public class StampWindowModel : NotifyModelBase, IClearModel, ILegacyModel
{
    ...
    public StampWindowModel(IReadOnlyDictionary<TextTemplateVariableType, decimal> evaluateStats, IEquipment equipment, IClass currentClass, IStampVariant startupStampVariant)
