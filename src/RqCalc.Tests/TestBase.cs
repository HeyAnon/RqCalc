...
public class MainTest(IServiceProvider serviceProvider)
{
    ...
    //public void Test1()
    //{
    //    var characterCalculator = serviceProvider.GetRequiredService<ICharacterCalculator>();


    //    var defChar = defaultCharacterSource.GetDefaultCharacter();

    //    var res = characterCalculator.Calculate(defChar);
    //}

    [Fact]
    public void TestDeserializeCodes_AllCodesDeserialized()
    {
        // Arrange
        ...
        var act = () =>
        {
            ...
            {
                characterStringSerializer.Parse(code);
            }
        };
