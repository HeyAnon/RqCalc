...
internal class BitReader
{
    ...
    public T Read<T>(IIndexedDict<T> dict)
    {
        return dict[this.Read(dict.BitSize)];
    }
    ...
    private IndexDictCollectionMode ReadDictMode()
    {
        return (IndexDictCollectionMode)this.ReadByMax(3);
    }
}