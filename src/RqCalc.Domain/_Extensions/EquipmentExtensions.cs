...
public static class EquipmentExtensions
{
    ...
    public static IEnumerable<IClass> GetClassConditions(this IEquipment equipment)
    {
        ...
        return conditions.Any() ? conditions.Aggregate((l1, l2) => l1.Union(l2).ToList()).Where(@class => @class.Specialization.MaxLevel == null || @class.Specialization.MaxLevel >= equipment.Level) : new IClass[0];
    }
